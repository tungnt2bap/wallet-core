...
class TestSpectreChainAddress {
    ...
    fun testAddress() {
        ...
        val address = AnyAddress(pubkey, CoinType.SPECTRECHAIN)
        val expected = AnyAddress("__EXPECTED_RESULT_ADDRESS__", CoinType.SPECTRECHAIN)
